...
python generate_response.py --split train --output_dir ../dataset/trivia_qa/train_response_temp=0_10000.jsonl --batch_size_testing 10 --do_sample False --temperature 0.1 --model_name /home/jl_fs/meta-llama/Llama-3.1-8B-Instruct-official --dataset trivia_qa
python generate_response.py --split test --output_dir ../dataset/trivia_qa/test_response_temp=0_10000.jsonl --batch_size_testing 10 --do_sample False --temperature 0.1 --model_name /home/jl_fs/meta-llama/Llama-3.1-8B-Instruct-official --dataset trivia_qa
