...
#Llama
paras="--add_loss_con False --on_policy False --batch_size_testing 4 --do_sample False --temperature 0 --use_peft --peft_method lora --model_name /home/tri/data/zhiyuan/lyb/meta-llama/Llama-3.1-8B-Instruct --output_dir checkpoints/lr1e5_e2_brier_bs16_tmp --dataset hotpot_qa --batch_size_training=4 --val_batch_size=4 --generate=llm --lr=1e-5 \ # 使用动态学习率 --loss_type=brier --num_epochs=2 --merge_peft True --use_wandb --resume True --id lr1e5_e2_brier_bs16_0507"
CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch \
            --num_processes 4 \
            --mixed_precision bf16 \
            --use_deepspeed \
