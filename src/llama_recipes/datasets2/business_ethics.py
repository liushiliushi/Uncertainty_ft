...
def get_business_ethics(tokenizer, split):
    if split == 'train':
        path = '/home/lyb/workspace/dataset/data/test/professional_law_test.csv'
        dataset = datasets.load_dataset('csv', data_files=path, split='train')
    else:
        path = '/home/lyb/workspace/dataset/data/val/professional_law_val.csv'
        dataset = datasets.load_dataset('csv', data_files=path, split='train')
