...
from llama_recipes.model_checkpointing import save_fsdp_model_checkpoint_full, save_model_and_optimizer_sharded, \
    save_optimizer_checkpoint, save_peft_checkpoint, save_model_checkpoint
        ...
        with MemoryTrace() as memtrace:  # track the memory usage
            ...
            with profile(train_config, local_rank) as profile_context:
                for step, batch in enumerate(train_dataloader):
                    ...
                    decoded_texts = [tokenizer.decode(indices[-1], skip_special_tokens=True) for indices in
                                     decoded_indices]
                    ...
                    print(
                        f"prob: {decoded_texts[0]}  {decoded_texts[1]}  {decoded_texts[2]}  {decoded_texts[3]}")  # {decoded_texts[4]}  {decoded_texts[5]}  {decoded_texts[6]}  {decoded_texts[7]}")
                    print(f"loss: {loss}")
...
def save_to_json(output_filename, train_step_loss, train_epoch_loss, train_step_ppl, train_epoch_ppl, val_step_loss,
