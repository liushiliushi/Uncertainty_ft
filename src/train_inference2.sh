...
paras="--add_loss_con True --on_policy False --batch_size_testing 4 --do_sample False --temperature 0 --use_peft --peft_method lora --model_name ../../meta-llama/Llama-3.1-8B-Instruct --output_dir checkpoints/trivia --dataset trivia_qa --batch_size_training=4 --val_batch_size=4 --generate=llm --lr=5e-5 --loss_type=brier --num_epochs=2 --merge_peft True --use_wandb --resume True --id trivia_0321"
